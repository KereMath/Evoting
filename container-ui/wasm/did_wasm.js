 ...
 * @returns {any}
 */
export function generate_did() {
    const ret = wasm.generate_did();
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function generate_o_value() {
    const ret = wasm.generate_o_value();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function recover_o_value(mnemonic_phrase) {
    const ptr0 = passStringToWasm0(mnemonic_phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.recover_o_value(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} did_hex
 * @param {string} o_hex
 * @returns {any}
 */
export function prepare_blind_sign(did_hex, o_hex) {
    const ptr0 = passStringToWasm0(did_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(o_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.prepare_blind_sign(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('did_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
