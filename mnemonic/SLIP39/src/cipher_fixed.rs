//! Fixed Feistel Cipher for SLIP-39 (Spec-compliant)
...
impl FeistelCipher {
    ...
    pub fn encrypt(&self, secret: &[u8], iteration_exponent: u8) -> Result<EncryptedSecret> {
        ...
        // Feistel: for each round, (l, r) -> (r, l XOR F(r))
